...
impl WantsInputs {
    ...
    // TODO: temporary hack. contribute_inputs should just return a ProvisionalProposal
    pub fn provisional_proposal(self) -> ProvisionalProposal {
        let inner = self.inner.provisional_proposal();
